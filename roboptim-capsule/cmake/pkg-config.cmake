...
MACRO(_SETUP_PROJECT_PKG_CONFIG_FINALIZE_DEBUG)
  ...
  message(STATUS "porcoddio ${_PKG_CONFIG_LIBS}")
...
MACRO(_PKG_CONFIG_MANIPULATE_LDFLAGS TARGET PREFIX CONFIG IS_GENERAL IS_DEBUG)
  ...
  # FUTHERMORE: use TARGET_LINK_LIBRARIES on targets to support modern cmake!!!
  FOREACH(FLAG ${${PREFIX}_LDFLAGS})
    # remove leading -l
    string(SUBSTRING ${FLAG} 2 -1 tgt)

    # if we have a target, link it with target_link_libraries
    if(TARGET ${tgt})
      TARGET_LINK_LIBRARIES(${TARGET} ${tgt})
